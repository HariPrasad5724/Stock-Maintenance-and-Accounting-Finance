...
import java.sql.*;
import javax.swing.*;
public class IncomeBills implements ActionListener
{
    JFrame f;
    ...
    IncomeBills()
    {
        ...
        lb4=new JLabel("AMOUNT RECIEVED:");
        ...
        jb1=new JButton("ADD SALES BILL");
        jb1.setBounds(100,300,180,50);
        f.add(jb1);
        
        jb2=new JButton("CLEAR");
        jb2.setBounds(310,300,130,50);
        f.add(jb2);
        ...
        if(ae.getSource()==jb1)
        {
             ...
             try
	     {
                      ...
                      if(rs.next())
                      {
                            ...
                            JOptionPane.showMessageDialog(null, "SALES BILLS ADDED SUCCESSFULLY!");
                      }
                      else
                      {
